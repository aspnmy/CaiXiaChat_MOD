...
{
    public partial class UI_BaseSpot : GButton
    {
        ...
        public const string URL = "ui://gfenp5kwklau108";

        public static UI_BaseSpot CreateInstance()
        {
            return (UI_BaseSpot)UIPackage.CreateObject("CaiXiaChat", "BaseSpot");
        }
